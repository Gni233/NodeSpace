...
export function resolveNodeDisplayLabel(
  positionedNode: { id?: unknown; label?: unknown; sourceRef?: { displayLabel?: unknown; heading?: unknown; path?: unknown } },
  graphNodeById: ReadonlyMap<string, { label?: unknown; sourceRef?: { displayLabel?: unknown; heading?: unknown; path?: unknown } }>,
): string {
  ...
  for (const candidate of [graphNode?.label, positionedNode?.label, sourceRef?.displayLabel, sourceRef?.heading]) {
