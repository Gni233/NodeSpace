...
export function showMedia(
  ...
  if (type === 'image') {
    ...
    mdDiv.style.cssText =
      `min-width:280px;max-width:520px;max-height:420px;overflow-y:auto;padding:12px;color:${V('--fg-text','#d0d0d0')};font-size:0.85em;outline:none;word-wrap:break-word;`;
    ...
    toggleBtn.style.cssText =
      `position:absolute;top:2px;left:6px;font-size:${V('--fg-font-xs','0.72em')};padding:0 5px;cursor:pointer;border:1px solid ${V('--fg-border-light','rgba(255,255,255,0.15)')};border-radius:3px;background:transparent;color:${V('--fg-text-muted','#999')};z-index:2;`;
    toggleBtn.onclick = () => {
  ...
  closeBtn.style.cssText =
    `position:absolute;top:2px;right:6px;width:16px;height:16px;font-size:9px;opacity:0.5;cursor:pointer;color:${V('--fg-text','#ccc')};line-height:16px;text-align:center;border-radius:3px;z-index:1;transition:all 0.15s ease;`;
